...
public class CalleServlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        switch(op)
        {
            case 1:
            {
                ...
                int codpro=Integer.parseInt(strcodpro);
                String strcoddepa=request.getParameter("cbDepartamento");
                int coddepa=Integer.parseInt(strcoddepa);
                DepartamentoBEAN depbean=new DepartamentoBEAN();
                depbean.setCodigoDepartamento(coddepa);
                ProvinciaBEAN probean=new ProvinciaBEAN();
                probean.setCodigoProvincia(codpro);
                DistritoDAO disdao=new DistritoDAO();
                ArrayList<DistritoBEAN> listadis;
                listadis=disdao.listarDistritos(depbean, probean);
                request.setAttribute("LISTADISTRITOS", listadis);
                
                String strcoddis=request.getParameter("cbDistrito");
                int dis=Integer.parseInt(strcoddis);
                String strcodprovi=request.getParameter("cbProvincia");
                int codprovi=Integer.parseInt(strcodprovi);
                String strcoddeparta=request.getParameter("cbDepartamento");
                int coddeparta=Integer.parseInt(strcoddeparta);
                DepartamentoBEAN objdep=new DepartamentoBEAN();
                objdep.setCodigoDepartamento(coddeparta);
                ProvinciaBEAN objpro=new ProvinciaBEAN();
                objpro.setCodigoProvincia(codprovi);
                DistritoBEAN objdis=new DistritoBEAN();
                objdis.setCodigoDistrito(dis);
                CalleDAO objcalledao=new CalleDAO();
                ArrayList<CalleBEAN> listacalle;
                listacalle=objcalledao.listarCalles(objdep, objpro, objdis);
                request.setAttribute("LISTACALLES", listacalle);
                
                String strcodcalle=request.getParameter("cbCalle");
                request.setAttribute("CODIGOCALLE", strcodcalle);
                request.setAttribute("CODIGODISTRITO", strcoddis);
