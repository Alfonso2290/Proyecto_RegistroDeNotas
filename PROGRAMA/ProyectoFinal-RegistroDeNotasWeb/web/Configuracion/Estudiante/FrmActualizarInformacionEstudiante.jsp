...
<html>
    <head>
        <title>ACTUALIZAR INFORMACIÓN ESTUDIANTE</title>
                ...
                <div class="DivPrincipalActualizarInfo">
                    ...
                    <table  class="TablaBotonesActualizarInfo">
                        <tr>
                            <td>
                                <center>
                                    <button type="button" class="botonActualizarInfo" onclick="ModificarUsuario('<%=request.getContextPath()%>','EstudianteServlet',13)">
