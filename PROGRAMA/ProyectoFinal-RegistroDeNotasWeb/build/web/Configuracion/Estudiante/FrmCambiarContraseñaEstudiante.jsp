...
<html>
    <head>
        ...
        <link href="<%=request.getContextPath()%>/css/HojaEstilo06.css" rel="stylesheet" type="text/css">
                ...
                <div class="DivPrincipalCambiarContra">
                    ...
                    <table  class="TablaBotonesActualizarInfo">
                        <tr>
                            <td>
                                <center>
                                    <button type="button" class="botonActualizarInfo" onclick="ActualizarContrasena('<%=request.getContextPath()%>','EstudianteServlet',12)">
