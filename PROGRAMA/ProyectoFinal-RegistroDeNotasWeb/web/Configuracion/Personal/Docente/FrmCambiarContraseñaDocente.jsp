...
<html>
    <head>
        <title>CAMBIAR CONTRASEÑA DOCENTE</title>
                ...
                <div class="DivPrincipalCambiarContra">
                    ...
                    <table  class="TablaBotonesActualizarInfo">
                        <tr>
                            <td>
                                <center>
                                    <button type="button" class="botonActualizarInfo" onclick="ActualizarContrasena('<%=request.getContextPath()%>','DocenteServlet',7)">
