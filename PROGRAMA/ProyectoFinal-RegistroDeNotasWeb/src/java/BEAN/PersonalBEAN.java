...
public class PersonalBEAN 
{
    ...
    private int CodigoPersonal,DNI;
    private String HoraIngreso,HoraSalida,Cargo;
    private int CodigoDistrito,CodigoProvincia,CodigoDepartamento;
    private int CodigoCalle,numInt,numExt;
    private String Nombre,ApellidoPaterno,ApellidoMaterno,Sexo,FechaNac,Correo,Telefono;
    private String nomDistrito,nomProvincia,nomDepartamento,nomCalle;
