...
//
function NuevoDocente(controlador,ruta,op)
{
...
//
function SalirDocente (controlador,ruta,op)
{
    document.form.action=controlador + "/" + ruta;
    document.form.method="POST";
    document.form.op.value=op;
...
//
function GuardarNuevoDocente (controlador,ruta,op)
{
...
//
function ModificarDocente(controlador,ruta,op,coddoc,dni,coddis,coddep,codpro,codcal,nom,apepa,apema,sexo,fecha,correo,tel,NumE,NumI)
{
    document.form.action=controlador + "/" + ruta;
    document.form.method="POST";
    document.form.op.value=op;
...
//
function ModificarRegistroDocente(controlador,ruta,op)
{
    var nom=document.form.txtNom.value;
    var apepa=document.form.txtApePa.value;
    var apema=document.form.txtApeMa.value;
...
//
function EliminarDocente (controlador,ruta,op,coddoc,dni)
{
    document.form.action=controlador + "/" + ruta;
    document.form.method="POST";
    document.form.op.value=op;
