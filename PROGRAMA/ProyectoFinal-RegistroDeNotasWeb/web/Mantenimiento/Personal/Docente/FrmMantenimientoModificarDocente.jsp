                ...
                <div class="DivPrincipalMantenimientoRegistrar">
                    ...
                    <table class="TablaPrincipalMantenimientoModificarDocente" cellpadding="7">
                        ...
                        <tr>
                            ...
                            <td><input type="text" disabled onkeypress="return soloNumeros(event)" name="txtNumE" class="Textbox" placeholder=" Ingrese Número Externo de su domicilio" value="<%=objdoc.getNumExt()%>"></td>
                        </tr>
                        <tr>
                            <td>Numero Interno:</td>
                            <td><input type="text" disabled onkeypress="return soloNumeros(event)" name="txtNumI" class="Textbox" placeholder=" Ingrese Número Interno de su domicilio" value="<%=objdoc.getNumInt()%>"></td>
                        </tr>
                    </table>
                    <br><br>
