...
<html>
    <head>
        <title>MANTENIMIENTO REGISTRAR TABLA DOCENTE</title>
    ...
    <body onload="FocoDNI()">
        <form name="form">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="CabeceraMenus">Registrar Tabla Docente</div>
            </nav>  
            <center>
                <div class="DivPrincipalMantenimientoRegistrar">
                    ...
                    <table class="TablaPrincipalMantenimientoRegistrarDocente" cellpadding="7">
                       
                        <tr>
                            <td>Departamento:</td>
                            <td>
                                <div>
                                <select name="cbDepartamento" class="ComboBoxActualizarInformacion" onchange="NuevoDocente('<%=request.getContextPath()%>','ProvinciaServlet',5)" >
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                <select name="cbProvincia" class="ComboBoxActualizarInformacion" onchange="NuevoDocente('<%=request.getContextPath()%>','DistritoServlet',5)">
                        ...
                        <tr>
                            <td>Disrito:</td>
                            <td>
                                <select name="cbDistrito" class="ComboBoxActualizarInformacion" onchange="NuevoDocente('<%=request.getContextPath()%>','CalleServlet',5)">
                                    <%
                    ...
                    <table class="TablaPrincipalMantenimiento2">
                        <tr>
                            <td>
                                <center>
                                    <button type="button" class="botonActualizarInfo" onclick="GuardarNuevoDocente('<%=request.getContextPath()%>','DocenteServlet',24)">
                            ...
                            <td>
                                <button type="button" class="botonRegistrar" onclick="SalirDocente('<%=request.getContextPath()%>','DocenteServlet',23)">
