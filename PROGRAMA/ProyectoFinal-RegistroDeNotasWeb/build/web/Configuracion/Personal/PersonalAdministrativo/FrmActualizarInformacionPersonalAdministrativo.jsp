...
<html>
    <head>
        <title>ACTUALIZAR INFORMACIÓN PERSONAL ADMINISTRATIVO</title>
                ...
                <div class="DivPrincipalActualizarInfo">
                    ...
                    <table  class="TablaBotonesActualizarInfo">    
                        <tr>
                            <td>
                                <center>
                                    <button type="button" class="botonActualizarInfo" onclick="ModificarUsuario('<%=request.getContextPath()%>','PersonalAdministrativoServlet',6)">
