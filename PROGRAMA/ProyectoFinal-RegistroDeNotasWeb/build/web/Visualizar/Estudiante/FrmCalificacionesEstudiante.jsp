...
<%!
    UsuarioBEAN usu;
    ArrayList<AulaBEAN> listaalumat;
...
<%
    ...
    listaalumat=(ArrayList<AulaBEAN>)request.getAttribute("LISTAMATERIAS");
    listaaluniv=(ArrayList<AulaBEAN>)request.getAttribute("LISTANIVELES");
    listaalucic=(ArrayList<AulaBEAN>)request.getAttribute("LISTACICLOS");
                    ...
                    strHTML+="<br><br>";
                        ...
                        strHTML+="<table cellpadding='10' id='miTabla' class='table table-bordered table-striped' border='2'>";
                                ...
                                strHTML+="<tr class='Columna1' style='background: lightblue;'>";
                                    strHTML+="<td>CODIGO MODULO</td>";
                                    strHTML+="<td>DOCENTE</td>";
                        ...
                        %>
                                strHTML+="<tr class='Columna1'>";
                                    ...
                                    strHTML+="<td><%=obj.getCodigoModulo()%></td>"; 
                                    strHTML+="<td><%=obj.getApePaternoDocente()%> <%=obj.getApeMaternoDocente()%> <%=obj.getNombreDocente()%></td>";
                            ...
                            strHTML+="<table  class='TablaPrincipalRegistroNotas03'>";
                                strHTML+="<tr class='Columna1'>";
                                    strHTML+="<td colspan='6'>";
                                        strHTML+="<center>";
                                            strHTML+="<button type='button' class='botonRegistrar' onclick='SalirRegistro(11)'>";
    ...
    <body onload="Foco()">
        <form name="form">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">  
                <%@include file="../../Menu/FrmMenuEstudiante.jsp" %>
                <div class="CabeceraMenus">Consulta de Notas</div>
            </nav>
                    ...
                    <table class="TablaPrincipalRegistroNotas">
                        ...
                        <tr class="Columna1">
                            <td>
                                <center>
                                    <div>
                                        <select name="cboMateria" class="ComboBoxMateria" onchange="EnlaceComboBox('<%=request.getContextPath()%>','EstudianteServlet',14)">
                            ...
                            <td>
                                <center>
                                    <div>
                                        <select name="cboNivel" class="ComboBoxMateria" onchange="EnlaceComboBox('<%=request.getContextPath()%>','EstudianteServlet',15)">
                            ...
                            <td>
                                <center>
                                    <div>
                                        <select name="cboCiclo" class="ComboBoxMateria" onchange="EnlaceComboBox('<%=request.getContextPath()%>','EstudianteServlet',16)">
                            ...
                            <td>
                                <center>
                                    <div>
                                        <select name="cboAula" class="ComboBoxMateria" onchange="EnlaceComboBox('<%=request.getContextPath()%>','EstudianteServlet',17)">
                        ...
                        <center>
                            <table class="TablaPrincipalRegistroNotas03">
                                <tr class="ColumnaSalirRegistro">
                                    <td >
                                        <center>
                                            <button type="button" class="botonRegistrar" onclick="SalirPrincipal('<%=request.getContextPath()%>','EstudianteServlet',11)">
