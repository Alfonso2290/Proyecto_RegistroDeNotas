...
<html>
    <head>
        <title>MANTENIMIENTO REGISTRAR TABLA PERSONAL ADMINISTRATIVO</title>
    ...
    <body onload="FocoDNI()">
        <form name="form">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="CabeceraMenus">Registrar Tabla Personal Administrativo</div>
            </nav>   
            <center>
                <div class="DivPrincipalMantenimientoRegistrar">
                    ...
                    <table class="TablaPrincipalMantenimientoRegistrarPersonal" cellpadding="7">
                        <tr>
                            <td>Departamento:</td>
                            <td>
                                <div>
                                <select name="cbDepartamento" class="ComboBoxActualizarInformacion" onchange="NuevoPersonal('<%=request.getContextPath()%>','ProvinciaServlet',1)" >
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                <select name="cbProvincia" class="ComboBoxActualizarInformacion" onchange="NuevoPersonal('<%=request.getContextPath()%>','DistritoServlet',1)">
                        ...
                        <tr>
                            <td>Disrito:</td>
                            <td>
                                <select name="cbDistrito" class="ComboBoxActualizarInformacion" onchange="NuevoPersonal('<%=request.getContextPath()%>','CalleServlet',1)">
                                    <%
                        ...
                        <tr>
                            <td>Cargo:</td>
                            <td><input type="text" name="txtCargo" class="Textbox" placeholder=" Ingrese Cargo" disabled></td>
                        </tr>
                        <tr>
                            <td>Hora Ingreso:</td>
                    ...
                    <table class="TablaPrincipalMantenimiento2">
                        <tr>
                            <td>
                                <center>
                                    <button type="button" class="botonActualizarInfo" onclick="GuardarNuevoPersonal('<%=request.getContextPath()%>','PersonalAdministrativoServlet',12)">
                            ...
                            <td>
                                <button type="button" class="botonRegistrar" onclick="SalirPersonal('<%=request.getContextPath()%>','PersonalAdministrativoServlet',11)">
