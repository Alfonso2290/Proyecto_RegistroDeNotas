...
<%
    ...
    objper=(PersonalBEAN)request.getAttribute("OBJETOPERSONAL");
...
<html>
    <head>
        <title>MANTENIMIENTO MODIFICAR TABLA PERSONAL ADMINISTRATIVO</title>
        ...
        <script src="<%=request.getContextPath()%>/javascript/Metodos7.js" type="text/javascript"></script>
    ...
    <body>
        <form name="form">
            ...
            <input type="hidden" name="codper" value="<%=objper.getCodigoPersonal()%>">
            <input type="hidden" name="dni" value="<%=objper.getDNI()%>">
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                <%@include file="../../../Menu/FrmMenuPersonalAdministrativo.jsp" %>
                <div class="CabeceraMenus">Modificar Tabla Personal Administrativo</div>
            </nav>  
            <center>
                <div class="DivPrincipalMantenimientoRegistrar"> 
                    ...
                    <table class="TablaPrincipalMantenimientoModificarPersonal" cellpadding="7">
                        <tr>
                            <td>Código Personal Administrativo:</td>
                            <td><input type="text" name="txtCodPer"  class="Textbox" disabled value="<%=objper.getCodigoPersonal()%>"></td>
                        </tr>
                        <tr>
                            <td>DNI:</td>
                            <td><input type="text" name="txtDNI"  class="Textbox" disabled value="<%=objper.getDNI()%>"></td>
                        </tr>
                        <tr>
                            <td>Departamento:</td>
                            <td>
                                <div>
                                <select name="cbDepartamento" class="ComboBoxActualizarInformacion" onchange="NuevoPersonal('<%=request.getContextPath()%>','ProvinciaServlet',2)" >
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                <select name="cbProvincia" class="ComboBoxActualizarInformacion" onchange="NuevoPersonal('<%=request.getContextPath()%>','DistritoServlet',2)">
                        ...
                        <tr>
                            <td>Disrito:</td>
                            <td>
                                <select name="cbDistrito" class="ComboBoxActualizarInformacion" onchange="NuevoPersonal('<%=request.getContextPath()%>','CalleServlet',2)">
                                    <%
                        ...
                        <tr>
                            <td>Nombre:</td>
                            <td><input type="text" name="txtNom" class="Textbox" placeholder=" Ingrese Nombre" disabled value="<%=objper.getNombre()%>"></td>
                        </tr>
                        <tr>
                            <td>Apellido Paterno:</td>
                            <td><input type="text" name="txtApePa" class="Textbox" placeholder=" Ingrese Apellido Paterno" disabled value="<%=objper.getApellidoPaterno()%>"></td>
                        </tr>
                        <tr>
                            <td>Apellido Materno:</td>
                            <td><input type="text" name="txtApeMa" class="Textbox" placeholder=" Ingrese Apellido Materno" disabled value="<%=objper.getApellidoMaterno()%>"></td>
                        </tr>
                        <tr>
                            <td>Cargo:</td>
                            <td><input type="text" name="txtCargo" class="Textbox" placeholder=" Ingrese Cargo" disabled value="<%=objper.getCargo()%>"></td>
                        </tr>
                        <tr>
                            <td>Hora Ingreso:</td>
                            <td><input type="time" name="txtHoraI" class="Textbox" disabled ></td>
                        </tr>
                        <tr>
                            <td>Hora Salida:</td>
                            <td><input type="time" name="txtHoraS" class="Textbox" disabled></td>
                        </tr>
                        <tr>
                            <td>Sexo:</td>
                            <td>
                                <select  name="cbSexo" class="ComboBoxActualizarInformacion" disabled>
                                    <%
                                        if(objper.getSexo().equals("Masculino")){
                                    %>
                        ...
                        <tr>
                            <td>Correo:</td>
                            <td><input type="email" name="txtCorreo" class="Textbox" placeholder=" Ejm: nombre@empresa.com" disabled value="<%=objper.getCorreo()%>"></td>
                        </tr>
                        <tr>
                            <td>Telefono:</td>
                            <td><input type="tel" name="txtTel" onkeypress="return soloNumeros(event)" class="Textbox" placeholder=" Ingrese Telefono referencial" disabled value="<%=objper.getTelefono()%>"></td>
                        </tr>
                        <tr>
                            <td>Numero Externo:</td>
                            <td><input type="text" disabled onkeypress="return soloNumeros(event)" name="txtNumE" class="Textbox" placeholder=" Ingrese Número Externo de su domicilio" value="<%=objper.getNumExt()%>"></td>
                        </tr>
                        <tr>
                            <td>Numero Interno:</td>
                            <td><input type="text" disabled onkeypress="return soloNumeros(event)" name="txtNumI" class="Textbox" placeholder=" Ingrese Número Interno de su domicilio" value="<%=objper.getNumInt()%>"></td>
                        </tr>
                    ...
                    <table class="TablaPrincipalMantenimiento2">
                        <tr>
                            <td>
                                <center>
                                    <button type="button" class="botonActualizarInfo" onclick="ModificarRegistroPersonalAdm('<%=request.getContextPath()%>','PersonalAdministrativoServlet',14)">
                            ...
                            <td>
                                <button type="button" class="botonActualizarInfo" onclick="SalirPersonal('<%=request.getContextPath()%>','PersonalAdministrativoServlet',11)">
